...
class TestCorrectImage_Calculate(unittest.TestCase):
    ...
    def test_03_05_splines(self):
        for automatic, bg_mode, spline_points, threshold, convergence, offset, hi, lo, succeed in (
                (True, centrosome.bg_compensate.MODE_AUTO, 5, 2, .001, 0, True, False, True),
                (True, centrosome.bg_compensate.MODE_AUTO, 5, 2, .001, .7, False, True, True),
                (True, centrosome.bg_compensate.MODE_AUTO, 5, 2, .001, .5, True, True, True),
                (False, centrosome.bg_compensate.MODE_AUTO, 5, 2, .001, 0, True, False, True),
                (False, centrosome.bg_compensate.MODE_AUTO, 5, 2, .001, .7, False, True, True),
                (False, centrosome.bg_compensate.MODE_AUTO, 5, 2, .001, .5, True, True, True),
                (False, centrosome.bg_compensate.MODE_BRIGHT, 5, 2, .001, .7, False, True, True),
                (False, centrosome.bg_compensate.MODE_DARK, 5, 2, .001, 0, True, False, True),
                (False, centrosome.bg_compensate.MODE_GRAY, 5, 2, .001, .5, True, True, True),
                (False, centrosome.bg_compensate.MODE_AUTO, 7, 2, .001, 0, True, False, True),
                (False, centrosome.bg_compensate.MODE_AUTO, 4, 2, .001, 0, True, False, True),
                (False, centrosome.bg_compensate.MODE_DARK, 5, 2, .001, .7, False, True, False),
                (False, centrosome.bg_compensate.MODE_BRIGHT, 5, 2, .001, 0, True, False, False)
        ):
...
"""
        ...
        self.assertEqual(module.spline_bg_mode, centrosome.bg_compensate.MODE_BRIGHT)
        ...
        for module, spline_bg_mode in zip(pipeline.modules()[1:4], (
                centrosome.bg_compensate.MODE_AUTO, centrosome.bg_compensate.MODE_DARK, centrosome.bg_compensate.MODE_GRAY)):
            self.assertTrue(isinstance(module, cellprofiler.modules.correctilluminationcalculate.CorrectIlluminationCalculate))
