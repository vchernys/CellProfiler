    ...
    def test_10_01_properties_file(self):
        ...
        try:
            ...
            for k, v in (
                    ...
                    ("image_path_cols", "%s_%s_%s" % (cellprofiler.measurement.IMAGE, cellprofiler.measurement.C_PATH_NAME, IMAGE_NAME)),
                    ("image_file_cols", "%s_%s_%s" % (cellprofiler.measurement.IMAGE, cellprofiler.measurement.C_FILE_NAME, IMAGE_NAME))):
