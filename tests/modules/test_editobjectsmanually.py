...
"""
    ...
    def test_02_02_measurements(self):
        ...
        expected_columns = [
            ...
            (OUTPUT_OBJECTS_NAME, cellprofiler.modules.identify.FF_PARENT % INPUT_OBJECTS_NAME, cellprofiler.measurement.COLTYPE_INTEGER),
            (INPUT_OBJECTS_NAME, cellprofiler.modules.identify.FF_CHILDREN_COUNT % OUTPUT_OBJECTS_NAME, cellprofiler.measurement.COLTYPE_INTEGER)]
        ...
        #
        d = {cellprofiler.measurement.IMAGE: {cellprofiler.modules.identify.C_COUNT: [OUTPUT_OBJECTS_NAME],
                            "Foo": []},
             INPUT_OBJECTS_NAME: {cellprofiler.modules.identify.C_CHILDREN: ["%s_Count" % OUTPUT_OBJECTS_NAME],
                                  "Foo": []},
             OUTPUT_OBJECTS_NAME: {
                 ...
                 cellprofiler.modules.identify.C_PARENT: [INPUT_OBJECTS_NAME],
