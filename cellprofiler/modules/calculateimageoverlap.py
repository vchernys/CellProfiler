...
class CalculateImageOverlap(cellprofiler.module.Module):
    ...
    def create_settings(self):
        ...
        self.decimation_method = cellprofiler.setting.Choice(
            ...
            reference images.</li>
            <li><i>{skeletonize}:</i> Select to skeletonize the image and pick
            points eqidistant along the skeleton. </li>
            </ul>
            <dl>
            <dd><img src="memory:{recommend_icon}">&nbsp;
            <i>{kmeans}</i> is a
            choice that's generally applicable to all images. <i>{skeletonize}</i>
